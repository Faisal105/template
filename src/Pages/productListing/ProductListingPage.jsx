                ...
                {products.length > 0 ? (
                          ...
                          <Image
                            src={
                              product?.firstVariantImage
                                ? `https://spartacus-demo.eastus.cloudapp.azure.com:8443/${product?.firstVariantImage}`
                                : product?.images && product.images.length > 1
                                  ? `https://spartacus-demo.eastus.cloudapp.azure.com:8443/${product.images[1].url}`
                                  : "default_image_url"
                            }
                            alt={product.name}
                  ...
                  <>
                    <h1 className="text-3xl text-gray-700">
                      No product found! Please try another filter...
                    </h1>
                  </>
                )}
              </div>
